...
export default function Header() {
  ...
  const fetchFilterEvent = useCallback(async (query) => {
    try {
      const reqData = { regex: query, page: 1, limit: 10, category: selectCategory };
              ...
              <div className="flex flex-col gap-2 p-3">
                <div className="flex flex-col pb-2 gap-2">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {categoryList.length !== 0 && categoryList.map(({ slug, title, _id }) => (
                      <p 
                      key={_id}
                  ...
                  <div className="flex flex-col pb-2 gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      {recentActivity.length === 0 ? (
                        <p className="text-sm text-center text-gray-500">No recent activity found</p>
                      ) : (
                        recentActivity.map((event, index) => (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm">{event.title || "Untitled Event"}</span>
                            </div>
                            {/* <button
                                  aria-label="Close"
                  ...
                  <div className="flex flex-col pb-2 gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      {filterEvent.length === 0 ? (
                        <div>
                          <p className="text-sm text-center text-gray-500">No events found</p>
                        </div>
                      ) : (
