...
export const OpenOrderDialog = ({openOrderDialog,setOpenOrderDialog,openOrderData,onOrderCancel}: any) =>{
                    ...
                    {openOrderData?.length>0 && openOrderData.map((item)=>(
                        <Fragment key={item._id}>
                            <tr>
                                ...
                                <td>
                                    <button className="text-red-500" onClick={()=>handleCancelOrder(item._id)}>
                                        <X size={20} />
                                    </button> 
                                </td>
                            </tr>
