...
>(({ className, value, ...props }, ref) => (
  <ProgressPrimitive.Root
    ref={ref}
    className={cn("relative h-[35px] w-full overflow-hidden bg-transparent", className)} // Changed bg-secondary to bg-pink-500
    {...props}>
    <ProgressPrimitive.Indicator
      className="h-full w-full flex-1 bg-[#ffd9d9] transition-all" // Changed bg-primary to bg-[#7dfdfe]
